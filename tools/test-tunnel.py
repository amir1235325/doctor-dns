...
check("a port that is taken is refused and asked again", got == "backpack reverse stealth 8447", got)
...
got = ask_now(["", "", "", "8447"])
check("changing only the port is one line typed", got == "backpack reverse wss 8447", got)
got = ask_now(["1"])
